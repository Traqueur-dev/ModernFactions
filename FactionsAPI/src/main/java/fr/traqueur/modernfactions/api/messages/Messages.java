...
public enum Messages implements Message {
    ...
    ROLE_COMMAND_MESSAGE,
    RECEIVER_ROLE_COMMAND_MESSAGE,
    CANT_SET_ROLE_MESSAGE,
    NOT_IN_THE_FACTION_MESSAGE, SETHOME_COMMAND_MESSAGE, SETHOME_COMMAND_ERROR_MESSAGE, HOME_TELEPORT_MESSAGE, HOME_COOLDOWN_MESSAGE, START_HOME_TELEPORT_MESSAGE, HOME_TELEPORT_ERROR_MESSAGE, HOME_NOT_SET_MESSAGE, DESCRIPTION_CHANGED_MESSAGE, CHAT_MODE_SET_MESSAGE;
