...
public enum Messages implements Message {
    ...
    NOT_IN_THE_FACTION_MESSAGE, SETHOME_COMMAND_MESSAGE, SETHOME_COMMAND_ERROR_MESSAGE, HOME_TELEPORT_MESSAGE, HOME_COOLDOWN_MESSAGE, START_HOME_TELEPORT_MESSAGE, HOME_TELEPORT_ERROR_MESSAGE;
