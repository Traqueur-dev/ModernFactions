...
public class FactionsCommandsHandler implements MessageHandler {
    ...
    public String getNoPermissionMessage() {
        return Messages.NO_PERMISSION_MESSAGE.translate();
    }

    @Override
    public String getOnlyInGameMessage() {
        return Messages.ONLY_IN_GAME_MESSAGE.translate();
    }

    @Override
    public String getMissingArgsMessage() {
        return Messages.MISSING_ARGS_MESSAGE.translate();
    }

    @Override
    public String getArgNotRecognized() {
        return Messages.ARG_NOT_RECOGNIZED_MESSAGE.translate();
    }

    @Override
    public String getRequirementMessage() {
        return Messages.NO_REQUIREMENT_MESSAGE.translate();
    }
}
