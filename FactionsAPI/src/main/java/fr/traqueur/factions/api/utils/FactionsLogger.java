package fr.traqueur.factions.api.utils;
...
public class FactionsLogger {
    ...
    static {
        LOGGER = JavaPlugin.getPlugin(FactionsPlugin.class).getLogger();
        colorFormatter = '&';
    }

    public static void info(String message) {
        FactionsLogger.log(Level.INFO, message);
    }

    public static void success(String message) {
        FactionsLogger.log(Level.INFO, "&a" + message);
    }

    public static void severe(String message) {
        FactionsLogger.log(Level.SEVERE, "&c" + message);
    }

    public static void warning(String message) {
        FactionsLogger.log(Level.WARNING, "&e" + message);}
